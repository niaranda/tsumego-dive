...
model.fit(X_train, y_train, epochs=300, validation_split=0.3, batch_size=32,
          callbacks=[TensorBoard(f"./tb_logs/correct_dense/09"), ])

model.save_weights("models/correct_dense09")

model.evaluate(X_train, y_train)  # accuracy: 0.3107 - topk3: 0.5665 - topk5: 0.6884 - topk10: 0.8195
model.evaluate(X_test, y_test)  # accuracy: 0.2806 - topk3: 0.5312 - topk5: 0.6575 - topk10: 0.7964
# test accuracy got worse
...
# accuracy: 0.2614 - topk3: 0.5315 - topk5: 0.6669 - topk10: 0.8073